...
function(CopyContent TO_TARGET DLL_DEBUG DLL_RELEASE)
    ...
    if(${IN_SAME_DIR})
        ...
        if(WIN32)
            ...
            file(GLOB DLL_LIST RELATIVE ${DLL_DEBUG} CONFIGURE_DEPENDS "${DLL_DEBUG}/*.so")
        endif()
        ...
        if(WIN32)
            ...
            list(FILTER DLL_LIST_DEBUG INCLUDE REGEX ".*d\.so")
            list(FILTER DLL_LIST_RELEASE EXCLUDE REGEX ".*d\.so")
        endif()
        ...
        if(WIN32)
            ...
            file(GLOB DLL_LIST_DEBUG RELATIVE ${DLL_DEBUG} CONFIGURE_DEPENDS "${DLL_DEBUG}/*.so")
            file(GLOB DLL_LIST_RELEASE RELATIVE ${DLL_RELEASE} CONFIGURE_DEPENDS "${DLL_RELEASE}/*.so")
        endif()
    endif()
    # Some info output
